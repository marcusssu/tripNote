...
$_SESSION["member"]=$currentuser;
function text_for_followbtn($currentuser,$membername){
...
function follow(membername) {
  ...
  xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
      document.getElementById("followbtn").innerHTML=xmlhttp.responseText;
    }
  }
  xmlhttp.open("GET","follow.php?q="+membername,true);
  xmlhttp.send();
}
  ...
  <script src='../js/refresh_tweets_member.js'></script>
  <script src='../js/refresh_flickr_member.js'></script>
  <script src='../js/refresh_notes_member.js'></script>
  ...
  <div class="container">
    ...
    <div class='box row marginleft marginright'>
      ...
      <br>
      <button style="margin-bottom:10px" id="followbtn" class="btn btn-primary btn-inline submitbutton" type="submit" name="follow" onclick="follow('<?php echo $profile_set['username']?>')"><?php text_for_followbtn($membername,$currentuser) ?></button>

      <div class="col-xs-3">
        <p>Twitter: <?php echo $profile_set['twitter']?></p>
    </div>
    <div class="col-xs-3">
        <p>Flickr: <?php echo $profile_set['flickr']?></p>
    </div>
    <div class="col-xs-3">
        <p>Email: <?php echo $profile_set['email']?></p>
    </div>
  </div>
    <div class="box">
     <div role="tabpanel">
